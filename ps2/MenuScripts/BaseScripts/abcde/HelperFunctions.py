...
class Helper:
    ...
    def cleanDump(self, dumpFile, baseheader):
        
        self.PointerHeader = baseheader
...
"""
    ...
    def removeBlankPointerData(self,fileName):
        ...
        fread = open(os.path.join( self.basePath, fileName),encoding="utf-8", mode="r")
        fwrite = open(os.path.join( self.basePath, "w"+fileName),encoding="utf-8", mode="w")
        ...
        #shutil.copyfile( os.path.join(self.basePath,"w"+fileName), os.path.join(self.basePath,fileName))
        os.remove(os.path.join(self.basePath,"w"+fileName))
    def getHeader(self):
